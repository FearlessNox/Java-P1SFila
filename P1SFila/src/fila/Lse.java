...
public class Lse
{
    ...
    public void consultar_posicao(int posicao)
    {
        ...
        for(aux = this.primeiro, pos = 1; aux != null; aux = aux.getProximo(), pos++) {
        	if(aux.getProximo() == null && (posicao > pos)||(posicao < 1)) 
        	{
        		Msg.msg_central ("Posição Inválida");
        	} 
        	if(pos == posicao) 
        	{
        		aux.mostra_noh(pos);
    ...
    public void consultar_conteudo_int(int conteudo)
    {
        ...
        for(aux = this.primeiro, pos = 1; aux != null; aux = aux.getProximo(), pos++) {
        	if(aux.getProximo() == null && (aux.getId() != conteudo)) 
        	{
        		Msg.msg_central ("ID Inválido");
        	} 
        	if(aux.getId() == conteudo) 
        	{
        		aux.mostra_noh(pos);
        	}
        }  
    ...
    public void consultar_conteudo_str(String conteudo)
    {
        ...
        for(aux = this.primeiro, pos = 1; aux != null; aux = aux.getProximo(), pos++) {
        	if(aux.getProximo() == null && (aux.getNome() != conteudo)) 
        	{
        		Msg.msg_central ("Nome Inválido");
        	} 
        	if(aux.getNome().equals(conteudo)) 
        	{
        		aux.mostra_noh(pos);
        	}
        } 
